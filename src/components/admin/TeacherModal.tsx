...
export const TeacherModal: React.FC<TeacherModalProps> = ({
  ...
  useEffect(() => {
    ...
    if (teacherToEdit) {
      ...
      setUsername(teacherToEdit.username || teacherToEdit.email?.split('@')[0] || '');
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    if (!cleanUsername) {
      setError('Login / Username is required for instructor account sign-in.');
      return;
    }
          ...
          <div>
            ...
            <div className="relative">
              ...
              <input
                ...
                placeholder="e.g. saidlaziz or teacher1"
